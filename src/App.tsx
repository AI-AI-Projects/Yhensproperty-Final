...
const CategoryListings = lazy(() => import('./pages/CategoryListings.tsx'));
...
const ForeignerOwnership = lazy(() => import('./pages/guides/ForeignerOwnership.tsx'));
const RA12252Lease = lazy(() => import('./pages/guides/RA12252Lease.tsx'));
const RentalYields = lazy(() => import('./pages/guides/RentalYields.tsx'));
const RetiringPhilippines = lazy(() => import('./pages/guides/RetiringPhilippines.tsx'));
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <Routes>
          ...
          <Route path="/property/:id" element={<PropertyDetails properties={properties} isLoading={loading} />} />
          ...
          <Route path="/guides/foreigner-property-ownership" element={<ForeignerOwnership />} />
          <Route path="/guides/ra-12252-99-year-lease" element={<RA12252Lease />} />
          <Route path="/guides/bgc-makati-batangas-rental-yields" element={<RentalYields />} />
          <Route path="/guides/retiring-philippines-srrv" element={<RetiringPhilippines />} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-8 lg:gap-x-12 gap-y-12">
              <div className="min-w-[120px]">
                ...
                <div className="flex gap-4">
                  ...
                  <a href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent("Hi Yhen,")}`} target="_blank" rel="noopener noreferrer"
                    className="whatsapp-conversion w-12 h-12 rounded-2xl bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center transition-all duration-500 hover:scale-110 hover:bg-[#25D366] group/wa shadow-sm" title="Contact us on WhatsApp">
                    <svg className="w-6 h-6 fill-zinc-600 dark:fill-zinc-400 group-hover/wa:fill-white transition-colors pointer-events-none" viewBox="0 0 24 24">
              ...
              <div className="min-w-[140px]">
                ...
                <ul className="space-y-4">
                  ...
                  <li><Link to="/guides" className="text-sm font-bold text-zinc-600 dark:text-zinc-400 hover:text-primary transition-colors">Investor Guides</Link></li>
                  <li><Link to="/inventory" className="text-sm font-bold text-zinc-600 dark:text-zinc-400 hover:text-primary transition-colors">Property Inventory</Link></li>
          ...
          <div className="pt-10 border-t border-zinc-200 dark:border-zinc-800 space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">
                © {siteConfig.copyright.year} {siteConfig.copyright.entity}. {siteConfig.copyright.descriptor}.
              </p>
