...
export const commissionService = {
  ...
  async updateCommission(
    ...
    if (updates.abby_paid !== undefined) {
      updateData.abby_payment_date = updates.abby_paid ? new Date().toISOString() : null;
    }

    if (updates.juvy_paid !== undefined) {
      updateData.juvy_payment_date = updates.juvy_paid ? new Date().toISOString() : null;
    }
