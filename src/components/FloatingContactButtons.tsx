  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      <a
        ...
        href="https://wa.me/639467543767"
        target="_blank"
        rel="noopener noreferrer"
        className="whatsapp-conversion w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all group"
