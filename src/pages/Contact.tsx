    ...
    <>
      <SEO
        ...
        breadcrumbs={[
          ...
          { name: "Contact", url: "https://yhensproperty.com/contact" }
        ]}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="whatsapp-conversion inline-flex items-center gap-2 px-6 py-3 bg-[#25D366] text-white font-bold rounded-xl hover:brightness-110 transition-all shadow-lg hover:scale-105"
                    onClick={() => { window.dataLayer = window.dataLayer || []; window.dataLayer.push({ event: 'whatsapp_click', button_location: 'contact_page' }); }}
                  >
          ...
          <div className="bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-100 dark:border-zinc-800 rounded-3xl p-8 lg:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-center min-h-[78px]" ref={captchaContainerRef}>
                {captchaVisible && (
